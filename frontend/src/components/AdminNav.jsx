...
const navItems = [
  ...
  { to: '/admin/landing', label: 'Landing', icon: 'Landing' },
  { to: '/admin/service-templates', label: 'Service Templates', icon: 'ServiceTemplates' },
  { to: '/admin/service-collections', label: 'Service Collections', icon: 'ServiceCollections' },
...
function NavIcon({ name }) {
  ...
  switch (name) {
    ...
    case 'Landing':
      return (
        <svg className={c} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2" /><rect x="7" y="7" width="4" height="4" rx="0.5" /><rect x="13" y="7" width="4" height="4" rx="0.5" /><rect x="7" y="13" width="4" height="4" rx="0.5" /><rect x="13" y="13" width="4" height="4" rx="0.5" /></svg>
      );
    case 'ServiceTemplates':
      return (
        <svg className={c} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22 6 12 13 2 6" /></svg>
      );
    case 'ServiceCollections':
      return (
        <svg className={c} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M2 6h4v12H2z" /><path d="M10 6h4v12h-4z" /><path d="M18 6h4v12h-4z" /></svg>
      );
    default:
      return null;
  }
